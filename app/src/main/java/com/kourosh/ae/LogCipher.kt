...
object LogCipher {
    ...
    private const val KEY_MATERIAL = "Kourosh-AE-log-cipher-v2.2.0-7a3f9c1e"

    private const val MAGIC = "Kourosh-AE-ENC-V1"
...
This file decrypts connection logs exported by Kourosh-AE ${appVersionReadable()}.
