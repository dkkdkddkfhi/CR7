...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        footerWave = OrbitFooterWave(this, palette, Strings.t("SECURED BY CR7"))
    ...
    private fun showOpeningOverlay() {
        ...
        val logo = ImageView(this).apply {
            setImageResource(R.drawable.ic_cr7_logo)
    ...
    private fun createHeader(): LinearLayout = LinearLayout(this).apply {
        ...
        addView(label(Strings.t("CR7"), 13f, MUTED, TypefaceStyle.MEDIUM).apply {
    ...
    private fun copyFullLog() {
        Thread({
            ...
            runOnUiThread {
                ...
                clipboard?.setPrimaryClip(ClipData.newPlainText(Strings.t("CR7 log"), text))
                    ...
                    startActivity(
                        Intent.createChooser(
                            Intent(Intent.ACTION_SEND)
                                .setType("text/plain")
                                .putExtra(Intent.EXTRA_SUBJECT, "CR7 log (encrypted)")
                ...
                result.onFailure {
                    ...
                    startActivity(
                        Intent.createChooser(
                            Intent(Intent.ACTION_SEND)
                                .setType("text/plain")
                                .putExtra(Intent.EXTRA_SUBJECT, "CR7 Log Key")
                                .putExtra(Intent.EXTRA_STREAM, uri)
                                .addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION),
                            Strings.t("Log Key"),
                        )
    ...
    private fun openModeScreen() {
        ...
        content.addView(label(Strings.t("Choose how CR7 connects"), 14f, MUTED), LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT,
        ).apply { leftMargin = dp(4); bottomMargin = dp(24) })
    ...
    private fun openSettingsScreen(animate: Boolean = true) {
        ...
        content.addView(expandableSection(Strings.t("ABOUT"), id = "ABOUT") { body ->
            ...
            body.addView(label("CR7 ${appVersion()}", 11.5f, Sculpt.withAlpha(MUTED, 0.7f)).apply {
                gravity = Gravity.CENTER_HORIZONTAL
    ...
    private fun chooseTunnelType() {
        ...
        showChoiceSheet(
            ...
            subtitle = Strings.t("How CR7 carries your traffic"),
    ...
    private fun openTrafficMonitorScreen() {
        ...
        content.addView(label(Strings.t("Traffic carried by CR7. Per-app attribution is not available from encrypted tunnel counters."), 14f, MUTED), LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT,
        ).apply { leftMargin = dp(4); bottomMargin = dp(24) })
    ...
    private fun openSplitTunnelScreen() {
        ...
        content.addView(header)
        content.addView(label(Strings.t("Choose which apps use CR7. Changes apply next connection."), 14f, MUTED), LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    private fun splitTunnelSummary(): String {
        ...
        return when (settings.mode()) {
            SplitTunnelSettings.Mode.ALL -> Strings.t("All apps use CR7")
