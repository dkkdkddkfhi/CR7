#!/usr/bin/env python3
"""Shrink Tor's GeoIP database to the countries KOUROSH-AE actually offers.
...
def filter_geoip(src: Path, keep: set[str]) -> tuple[str, int, int]:
    ...
    note = [
        "# Filtered for KOUROSH-AE: only the countries offered by the app's Tor",
...
STUB6 = """\
# KOUROSH-AE: intentionally contains no ranges.
#
